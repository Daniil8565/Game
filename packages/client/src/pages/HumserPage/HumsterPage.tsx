  ...
  const createCanvas = () => {
    ...
    function drawCircle() {
      ...
      const large_circle_size =
        height > width ? circle_size * 0.4 : circle_size * 0.3
      ...
      const small_circle_size =
        height > width ? circle_size * 0.35 : circle_size * 0.25
      const radial_gradient = context.createRadialGradient(
        circle_x,
        circle_y,
        0,
      ...
      context.fillStyle = radial_gradient
      context.arc(circle_x, circle_y, small_circle_size, 0, 360)
      context.closePath()
      context.fill()
    }
